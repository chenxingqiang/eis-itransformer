...
if __name__ == "__main__":
    ...
    parser.add_argument("--mps", type=int, default=0, help="mps")
    parser.add_argument(
        "--use_multi_mps", action="store_true", help="use multiple mpss", default=False
    )
    parser.add_argument(
        "--devices", type=str, default="0,1,2,3", help="device ids of multile mpss"
    )
    ...
    parser.add_argument("--num_ecm_paramsm", type=int, default=4, help="等效电路参数")
    parser.add_argument(
        "--partial_start_index",
        type=int,
        default=0,
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = "{}_{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_ec{}_dt{}_{}_{}".format(
                args.model_id,
                args.model,
                args.data,
                args.features,
