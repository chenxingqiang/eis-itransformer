...
class Exp_Long_Term_Forecast_Partial(Exp_Basic):
    ...
    def _get_data(self, flag):
        ...
        # 加载 EIS 数据
        eis_data_path = os.path.join(self.args.data_path, f'{flag}_eis.csv')  # 假设 EIS 数据存储在单独的 CSV 文件中
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (
                ...
                # 准备 EIS 数据
                batch_eis_data = batch_eis_data.float().to(self.device)
